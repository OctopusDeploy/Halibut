...
namespace Halibut.Diagnostics
{
    public class HalibutLimits
    {
        ...
        /// </summary>
        public static TimeSpan PollingRequestQueueTimeout => TimeSpan.FromSeconds(120*Multiplier);
        ...
        /// </summary>
        public static TimeSpan PollingRequestMaximumMessageProcessingTimeout => TimeSpan.FromSeconds(10 * 60 * Multiplier);
        ...
        /// </summary>
        public static TimeSpan ConnectionErrorRetryTimeout => TimeSpan.FromSeconds(5 * 60 * Multiplier);
        ...
        /// </summary>
        public static TimeSpan TcpClientSendTimeout => TimeSpan.FromSeconds(10 * 60 * Multiplier);
        
        /// <summary>
        /// Amount of time to wait for a TCP or SslStream read to complete successfully
        /// </summary>
        public static TimeSpan TcpClientReceiveTimeout => TimeSpan.FromSeconds(10 * 60 * Multiplier);
        
        /// <summary>
        /// Amount of time a connection can stay in the pool
        /// </summary>
        public static TimeSpan TcpClientPooledConnectionTimeout => TimeSpan.FromSeconds(9 * 60 * Multiplier);
        
        public static TimeSpan TcpClientHeartbeatSendTimeout => TimeSpan.FromSeconds(60 * Multiplier);
        public static TimeSpan TcpClientHeartbeatReceiveTimeout => TimeSpan.FromSeconds(60 * Multiplier);
        
        /// <summary>
        /// Amount of time to wait for a successful TCP or WSS connection
        /// </summary>
        public static TimeSpan TcpClientConnectTimeout => TimeSpan.FromSeconds(60 * Multiplier);
