...
namespace Halibut.Diagnostics
{
    public class HalibutTimeoutsAndLimits
    {
        public HalibutTimeoutsAndLimits(
            ...
            TimeSpan retryListeningSleepInterval,
            int retryCountLimit,
            TimeSpan connectionErrorRetryTimeout, 
            int rewindableBufferStreamSize,
            SendReceiveTimeout tcpClientTimeout, 
            TimeSpan tcpClientReceiveResponseTimeout, 
            TimeSpan tcpClientReceiveRequestTimeoutForPolling, 
            TimeSpan tcpClientPooledConnectionTimeout,
            TimeSpan tcpListeningNextRequestIdleTimeout, 
            SendReceiveTimeout tcpClientHeartbeatTimeout, 
            bool tcpClientHeartbeatTimeoutShouldActuallyBeUsed, 
            TimeSpan tcpClientConnectTimeout, 
            ...
            TimeSpan tcpKeepAliveInterval)
        {
            ...
            RewindableBufferStreamSize = rewindableBufferStreamSize;
            TcpClientTimeout = tcpClientTimeout;
            TcpClientReceiveResponseTimeout = tcpClientReceiveResponseTimeout;
            TcpClientReceiveRequestTimeoutForPolling = tcpClientReceiveRequestTimeoutForPolling;
            TcpClientPooledConnectionTimeout = tcpClientPooledConnectionTimeout;
            TcpListeningNextRequestIdleTimeout = tcpListeningNextRequestIdleTimeout;
            TcpClientHeartbeatTimeout = tcpClientHeartbeatTimeout;
            TcpClientHeartbeatTimeoutShouldActuallyBeUsed = tcpClientHeartbeatTimeoutShouldActuallyBeUsed;
        ...
        /// </summary>
        public TimeSpan PollingRequestQueueTimeout { get; }
        ...
        /// </summary>
        public TimeSpan PollingRequestMaximumMessageProcessingTimeout { get; }
        ...
        /// </summary>
        public TimeSpan ConnectionErrorRetryTimeout { get; }
        ...
        ///     side-effects.
        /// </remarks>
        public int RewindableBufferStreamSize { get; }
        ...
        /// </summary>
        public SendReceiveTimeout TcpClientTimeout { get; }
        ...
        /// </summary>
        public TimeSpan TcpClientReceiveResponseTimeout { get; }
        ...
        /// </summary>
        public TimeSpan TcpClientReceiveRequestTimeoutForPolling { get; }

        /// <summary>
        ///     Amount of time a connection can stay in the pool
        /// </summary>
        public TimeSpan TcpClientPooledConnectionTimeout { get; }
        ...
        /// </summary>
        public TimeSpan TcpListeningNextRequestIdleTimeout { get; }
        ...
        ///     listening service. 
        /// </summary>
        public SendReceiveTimeout TcpClientHeartbeatTimeout { get; }

        /// <summary>
        ///     When true the TcpClientHeartbeatTimeout is used in all places it can be.
        ///     Will be removed in the future.
        /// </summary>
        public bool TcpClientHeartbeatTimeoutShouldActuallyBeUsed { get; }

        /// <summary>
        ///     Amount of time to wait for a successful TCP or WSS connection
        /// </summary>
        public TimeSpan TcpClientConnectTimeout { get; }
        ...
        ///     re-request.
        /// </summary>
        public TimeSpan PollingQueueWaitTimeout { get; }
        ...
        /// </summary>
        public bool TcpKeepAliveEnabled { get; }
