...
namespace Halibut.Tests.Support
{
    public class LatestClientAndLatestServiceBuilder : IClientAndServiceBuilder
    {
        ...
        {
            readonly LatestClientBuilder.ClientOnly client;
            readonly LatestServiceBuilder.ServiceOnly service;

            public ClientAndService(
                LatestClientBuilder.ClientOnly client,
                LatestServiceBuilder.ServiceOnly service,
