...
{
    // To make this work, we have to hook it up as the TestFramework in AssemblyInfo (including namespace)
    sealed class ParallelTestFramework : XunitTestFramework
    {
        ...
        sealed class CustomTestExecutor : XunitTestFrameworkExecutor
        {
            ...
            /// </summary>
            IEnumerable<IXunitTestCase> SetUpTestCaseParallelization(IEnumerable<IXunitTestCase> testCases)
            {
